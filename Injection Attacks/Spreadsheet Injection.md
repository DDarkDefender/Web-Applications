...
> This vulnerability can only be exploited if the participant's Excel environment has Dynamic Data Exchange (DDE) enabled {File > Options > Trust Center > External Content > Enable Dynamic Data Exchange Server Lookup and Dynamic Data Exchange Server Launch}.
